...
CREATE TABLE `comments_comments` (
  ...
  `author_ip` char(32) NOT NULL,
  `created` int(11) unsigned NOT NULL default '0',
  `edit_times` int(10) unsigned NOT NULL default '0',
...
INSERT INTO `comments_comments` VALUES (1,'test',2,'',1248489822,0,0,2,1,0,0),(2,'test',1,'',1248493855,0,0,2,0,0,0),(3,'test',2,'',1248949870,0,0,1,2,0,0),(4,'test',2,'',1248949904,0,0,1,-10,0,0),(5,'test3',2,'',1248949924,0,0,1,5,0,0),(6,'test4',2,'',1248950009,0,0,1,0,0,0),(7,'test5',2,'',1248950053,0,0,1,1,0,0),(8,'test56',2,'',1248950180,0,0,1,-1,0,0),(9,'sdgfsdf',2,'',1248950407,0,0,1,0,0,0),(10,'test',2,'',1249123678,0,0,2,1,0,0),(11,'test22222211111',1,'',1252543218,3,1263992478,8,0,1,0),(12,'ёёёё!',1,'',1252561959,0,0,6,0,0,0),(13,'стотыщраз!11111',1,'',1252562152,0,0,8,0,0,0),(14,'фывафыва',1,'',1252562157,0,0,8,-1,0,1),(15,'test32',2,'',1262931692,0,0,8,0,0,0),(16,'trololo',2,'',1263565387,0,0,8,0,0,0),(17,'trululu',2,'',1263565501,1,1263992572,8,0,0,0),(18,'sdfsdf',2,'',1263566367,0,0,7,0,0,0),(19,'zskdfjslkdfj',2,'',1263566482,0,0,5,0,0,0),(20,'sdfsdf',2,'',1263567040,0,0,3,0,0,0),(21,'казу казу казу',2,'',1263568350,0,0,5,0,0,0),(22,'test',2,'',1263986096,0,0,8,0,0,0),(23,'asdfsdaf',2,'',1263986118,0,0,8,0,0,0),(24,'test2123123',2,'',1263989381,0,0,8,0,0,0),(25,'ololo2d',2,'',1263989393,1,1263992548,8,0,1,0),(26,'dfgfdsg',2,'',1263989863,0,0,8,0,0,0),(27,'asdf',2,'',1263990127,0,0,8,0,0,0),(28,'test',1,'',1263992017,0,0,8,0,0,0),(29,'oioi',6,'',1263992139,5,1263992411,8,0,0,0),(30,'test2',6,'',1263992230,1,1263992237,8,0,0,0),(31,'test',2,'127.0.0.1',1280541407,0,0,6,0,0,0),(32,'test',2,'127.0.0.1',1280541465,0,0,3,0,0,0),(33,'asdfasdf',1,'127.0.0.1',1295365161,0,0,2,0,0,0),(34,'test',1,'127.0.0.1',1295365642,0,0,1,0,0,0),(35,'asdf',1,'127.0.0.1',1295365661,0,0,4,0,0,0),(36,'test',1,'127.0.0.1',1295365674,0,0,1,0,0,0);
...
INSERT INTO `comments_commentsFolder` VALUES (1,3,'quoter','quote','id',7),(2,1,'quoter','quote','id',3),(3,2,'quoter','quote','id',1),(4,5,'quoter','quote','id',0),(5,4,'quoter','quote','id',2),(6,6,'quoter','quote','id',1),(7,7,'quoter','quote','id',1),(8,8,'quoter','quote','id',15);
...
INSERT INTO `comments_comments_lseen` VALUES (3,6,2,1,1252562007),(26,8,2,15,1263992470),(9,7,2,1,1263566367),(14,5,2,2,1263568350),(27,3,2,1,1280541466),(25,8,6,15,1263992231);
...
CREATE TABLE `quoter_quote` (
  ...
  `comments_count` int(10) unsigned NOT NULL default '0',
  `best_in_month` tinyint(4) NOT NULL default '0',
  `best_in_week` tinyint(4) NOT NULL default '0',
  `best_in_day` tinyint(4) NOT NULL default '0',
  `best_in_day_time` int(10) unsigned NOT NULL default '0',
  `best_in_week_time` int(10) unsigned NOT NULL default '0',
  `best_in_month_time` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`id`),
...
INSERT INTO `quoter_quote` VALUES (1,1,1,1248257061,'$error = \"Всё хорошо\"; \r\nif (!$_POST[\'mail\'] || !checkEmail($_POST[\'mail\'])) {\r\n    $error .= \"Не верный E-mail\";\r\n}\r\n \r\n...\r\n \r\nif ($error == \"Всё хорошо\") {    $db->query(\"INSERT...\r\n} else {\r\n \r\n...','',-1,1,2,33,3,0,0,0,0,0,0),(2,7,2,1248257148,'asdfasdf','asdfasdf',5,0,0,32,1,0,0,0,0,0,0),(3,1,1,1248473224,'sdfsadf\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nasdfsdaf','asdfasdf',-2,0,2,36,7,0,0,0,0,0,0),(4,2,2,1250166047,'еуые\nsdfsdfasdf','еуые',0.3,1,0,21,2,0,0,0,0,0,0),(5,2,2,1250166079,'еуые','еуые',0.3,1,0,35,0,0,0,0,0,0,0),(6,3,2,1252065170,'SELECT * FROM\n`table`','asdfsadf\nas\ndf\nasdfasdf',0.1,1,0,31,1,0,0,0,0,0,0),(7,9,2,1252065623,'sdfasdfasdf','sdfsadf',0.3,3,0,18,1,0,0,0,0,0,0),(8,5,2,1252066462,'sdfasdf\nsdfasdf\nv\n\nsdfasdf\nsdfasdf\ns\ndf\nsad\nf\nasdf\nas\ndf\nasd\nf\nasd\nfa\nsdf\nas\ndf\nasd\nf\nasd\nf\nasdf\nsa\ndf\nas\ndf\nasd\nf\nsadfsdaf','',0.4,3,0,30,15,0,0,0,0,0,0);
...
INSERT INTO `ratings_ratingsFolder` VALUES (1,'quoter','quote',1,0,0.3,5),(2,'quoter','quote',3,0,0.3,7),(3,'comments','comments',1,0,0.2,11),(4,'quoter','quote',3,0,0.4,8),(5,'quoter','quote',1,0,0.1,6),(6,'comments','comments',0,1,-1,14),(7,'quoter','quote',1,0,0.3,4),(8,'comments','comments',1,0,0.2,25),(9,'comments','comments',0,0,0,15);
...
INSERT INTO `user_user` VALUES (1,'guest','','',0,'','',0,1248576546,3,1,2,'js',0,'',0),(2,'admin','','098f6bcd4621d373cade4e832627b4f6',0,'','',0,1268543196,10,1,6,'geshi',2,'',0),(6,'striker','striker@bk.ru','202cb962ac59075b964b07152d234b70',1263629202,'','',0,1268542296,3,1,0,'js',2,'',0),(5,'sdfasdfasdfsdf','sadfsadfsdf@sdfasdf.ru','202cb962ac59075b964b07152d234b70',1253961805,'','',0,1253961805,-5,1,0,'js',2,'',0),(7,'striker123','striker123@bk.ru','202cb962ac59075b964b07152d234b70',1263629733,'','',0,1263629733,3,1,0,'js',2,'',0),(8,'striker123123','wii.striker@gmail.com','202cb962ac59075b964b07152d234b70',1263633882,'','',0,1263633882,3,1,0,'js',2,'',0),(9,'tester','','202cb962ac59075b964b07152d234b70',1291439700,'','',0,1291444406,3,1,0,'js',2,'',0),(10,'123','','202cb962ac59075b964b07152d234b70',1291439937,'','',0,1291440153,3,1,0,'js',2,'',0),(11,'test2','','202cb962ac59075b964b07152d234b70',1291444421,'','',0,1291444440,3,1,0,'js',2,'',0),(12,'test4','','202cb962ac59075b964b07152d234b70',1291444486,'','',0,1291444486,3,1,0,'js',2,'',0);
...
INSERT INTO `user_userGroup_rel` VALUES (1,1,1),(2,3,2),(3,2,6),(4,2,7),(7,2,8),(8,2,12);
