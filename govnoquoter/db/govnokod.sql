...
INSERT INTO `quoter_quote` VALUES (1,1,1,1248257061,'$error = \"Всё хорошо\"; \r\nif (!$_POST[\'mail\'] || !checkEmail($_POST[\'mail\'])) {\r\n    $error .= \"Не верный E-mail\";\r\n}\r\n \r\n...\r\n \r\nif ($error == \"Всё хорошо\") {    $db->query(\"INSERT...\r\n} else {\r\n \r\n...','',-1,1,2,0,3,0,0,0),(2,7,2,1248257148,'asdfasdf','asdfasdf',5,0,0,32,1,0,0,0),(3,1,1,1248473224,'sdfsadf\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nasdfsdaf','asdfasdf',-2,0,2,0,7,0,0,0),(4,2,2,1250166047,'еуые\nsdfsdfasdf','еуые',0.3,1,0,21,2,0,0,0),(5,2,2,1250166079,'еуые','еуые',0.3,1,0,0,0,0,0,0),(6,3,2,1252065170,'SELECT * FROM\n`table`','asdfsadf\nas\ndf\nasdfasdf',0.1,1,0,31,1,0,0,0),(7,9,2,1252065623,'sdfasdfasdf','sdfsadf',0.3,3,0,18,1,0,0,0),(8,5,2,1252066462,'sdfasdf\nsdfasdf\nv\n\nsdfasdf\nsdfasdf\ns\ndf\nsad\nf\nasdf\nas\ndf\nasd\nf\nasd\nfa\nsdf\nas\ndf\nasd\nf\nasd\nf\nasdf\nsa\ndf\nas\ndf\nasd\nf\nsadfsdaf','',0.4,3,0,30,15,0,0,0);
...
-- Dump completed on 2010-12-18 15:07:53
