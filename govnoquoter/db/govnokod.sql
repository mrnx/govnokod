...
INSERT INTO `quoter_quoteCategory` (`id`, `obj_id`, `name`, `title`) VALUES 
  (1,1304,'php','PHP');
COMMIT;
...
AUTO_INCREMENT=1308 ROW_FORMAT=FIXED CHARACTER SET 'utf8' COLLATE 'utf8_general_ci';
...
AUTO_INCREMENT=294 ROW_FORMAT=FIXED CHARACTER SET 'utf8' COLLATE 'utf8_general_ci';
...
INSERT INTO `sys_obj_id_named` (`obj_id`, `name`) VALUES 
  ...
  (1302,'access_quoter_quote'),
  (1303,'access_quoter_quoteCategory'),
  (1305,'access_quoter_quoteFolder');
COMMIT;
...
INSERT INTO `user_userAuth` (`id`, `user_id`, `ip`, `hash`, `obj_id`, `time`) VALUES 
  ...
  (114,2,'127.0.0.1','c425edb975baa5d8c782209ffaa3683a',NULL,1226145520);
COMMIT;
...
INSERT INTO `user_userOnline` (`id`, `user_id`, `session`, `last_activity`, `url`, `ip`) VALUES 
  (318,2,'a1170c6e515f74cdc20ce7c2f4627ee7',1226165296,'http://govnokod/quoter/listAll','127.0.0.1');
COMMIT;
