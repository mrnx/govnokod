    ...
    {/if}
    <dl>
        <dt><img class="avatar" src="{$user->getAvatarUrl(28)|h}" alt="ava" title="Аватар" /> Я, <strong>{$user->getLogin()|h}</strong>, находясь в здравом уме и твердой памяти, торжественно заявляю:</dt>
