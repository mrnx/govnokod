    ...
    <div class="inner-box">
        ...
        <table class="addcomment">
            ...
            <tr>
              ...
              <td>{if $errors->has('text')}<span class="fielderror">{$errors->get('text')}</span><br />{/if}{form->textarea name="text" style="font-size:18px;width:100%" value=$text rows="5" cols="45"}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>&nbsp;</td>
              <td>{form->submit name="submit" value="Готово!" style="font-size: 48px;"}</td>
            </tr>
        </table>
        {form->hidden name="url" value=$url}
        </form>
