    <h3>Комментарии <span class="count">({$comments->count()})</span> <span class="rss"><a href="{url route="withId" module="comments" action="rss" id=$commentsFolder->getId()}" rel="alternative">RSS</a></span></h3>
