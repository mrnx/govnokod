...
{/if}
    <li class="hentry">
        ...
        <div class="entry-comments">
            <a href="{url route="quoteView" id=$quote->getId()}" class="entry-comments-load">Комментарии</a> <span class="count">({$quote->getCommentsCount()} / {$quote->getNewCommentsCount()})</span>
        </div>
    </li>