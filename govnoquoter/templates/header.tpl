...
<head>
    ...
    <link rel="stylesheet" href="{$SITE_PATH}/css/style.css" media="all" type="text/css" />
    <!--[if lte IE 7]><link href="{$SITE_PATH}/css/ie.css?v=2" rel="stylesheet" type="text/css"><![endif]-->
